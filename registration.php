...
if(isset($_POST['st_submit'])){
	...
	if(empty($st_name)){
		...
		$error = "Character will be more than or equal 6 digit!";
	}
	else{
...
<html lang="en">
						...
						<div class="row placeani">
							...
							<div class="col-lg-12">
								<div class="form-group">
									...
									<label for=""><input name="st_gender" type="radio" value="Male" checked>&nbsp; Male</label> &nbsp;
									<label for=""><input name="st_gender" type="radio" value="Female">&nbsp; Female</label>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form-group">
							...
							<div class="col-lg-12 m-b30">
								<button name="st_submit" type="submit" value="Submit" class="btn button-md">Sign Up</button>
							</div>
	...
	<!-- <script src='assets/vendors/switcher/switcher.js'></script>  color skin ta off korar jonno ei link hide korsi -->
	</body>
